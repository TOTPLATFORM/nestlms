    ...
    <div className='flex min-h-screen items-center justify-center bg-gradient-to-b from-blue-50 to-blue-100'>
      <div className='container my-28 min-h-full  rounded bg-white p-10 shadow-md'>
        ...
        <div className='prose max-w-none text-gray-700'>
          <>
            <p>
              Welcome to our Online Learning Platform! We are delighted to have
              you as part of our educational community. These Terms and
            ...
            <p>
              You acknowledge that you have read, understood, and accepted these
              terms and conditions. Your access to our services is contingent
              upon your agreement to be bound by these terms. If you do not
              agree with any part of these terms, kindly refrain from accessing
              our services.
            </p>

            <p>
              We strive to create a positive and respectful learning environment
              for all users. As a member of our community, you are expected to
              conduct yourself in a manner that promotes collaboration and
              inclusivity in the educational experience.
            </p>

            <h2 className='mt-4 text-xl font-semibold'>1. User Accounts</h2>
            <p>
              Certain features of the platform may require you to create a user
              account. It is your responsibility to maintain the confidentiality
              of your account and password. Any activities that occur under your
            ...
            <p>
              ...
              images, and software, is the intellectual property of our platform
              and is protected by applicable laws. Without our express consent,
              you agree not to reproduce, distribute, modify, or create
              derivative works from any content.
            </p>
            ...
            <p>
              ...
              suitability of the information provided. Users are encouraged to
              use the information at their own risk.
            </p>

            <h2 className='mt-4 text-xl font-semibold'>6. Revisions</h2>
            <p>
              We may make revisions to these terms and conditions without prior
